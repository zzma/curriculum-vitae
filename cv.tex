...
\section{Mentorship} 
\begin{tabular}{rlll}
% 2021 -- \textsc{present} & \textbf{Kleanthis Karakolios} & \textsc{PhD} & Adversarial ML for DNS reputation.\\ 
% 2021 -- \textsc{present} & \textbf{Thomas Papastergiou} & \textsc{PhD} & 5G SDN Network Defenses.\\ 
% 2021 -- \textsc{present} & \textbf{Konstantinos Karakatsanis} & \textsc{PhD} & Email abuse and data sharing.\\ 
% 2021 -- \textsc{present} & \textbf{Athanasios Avgetidis} & \textsc{PhD} & Malware DNS lifecycle dynamics.\\ 
% 2021 -- \textsc{present} & \textbf{Aaron Faulkenberry} & \textsc{PhD} & DNS name registration abuse.\\ 
...
\begin{tabular}{rl}
Oct. 2021 & \textbf{What's in a Name? Exploring CA Certificate Control}\\

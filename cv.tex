...
% 2024 -- \textsc{pres.} & \textbf{Junbeom In} & SOC operations.\\ 
\end{tabular}\\

% \subsubsection*{Masters students}
% \begin{tabular}{rll}
% % 2023 -- \textsc{pres.} & \textbf{Lucas Ball} & \\ 
% % 2024 -- \textsc{pres.} & \textbf{Junbeom In} & Ph.D. & SOC operations.\\ 
% \end{tabular}\\
...
%2022 -- 2023             & \textbf{Pierros-Christos Skafidas} & \textsc{Ph.D.} & Security threat log correlation.\\ 
%2021 -- 2023             & \textbf{Kevin Valakuzhy} & \textsc{Ph.D.} & Automated malware analysis.\\ 
%2021 -- 2023             & \textbf{Thomas Papastergiou} & \textsc{Ph.D.} & TLS certificate ownership.\\ 
